    ...
    renderInputForm = () => {
        return (
            <View style={styles.inputFormHeader}>
                ...
                />
                <TouchableOpacity disabled={this.state.country.trim().length === 0} onPress={() => this.onPressSubmitButton()} style={[styles.submitButton, { backgroundColor: this.state.country.trim().length === 0 ? 'grey' : 'orange'}]}>
